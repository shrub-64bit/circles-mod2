...
function circleTextControls(){
    ...
    document.getElementById("descText").innerText = `Circle 2 (${formatWhole(data.numbers[1])}%) provides a ${format(effect)}x boost to the speed of Circle 1.`
...
// space filling
    ...
    document.getElementById("descText4").innerText = `Circle 10 (${formatWhole(data.numbers[9])}%) increases the minimum percent of all lower Circles by ${format(minimumNumber(0).sub(1))}%`
}
